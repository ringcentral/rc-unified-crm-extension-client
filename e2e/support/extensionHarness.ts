...
export async function seedExtensionStorage(extension, seed) {
...
export async function readExtensionStorage(extension, keys) {
  const page = await extension.context.newPage();
  await page.goto(`chrome-extension://${extension.extensionId}/options.html`);
...
export async function sendExtensionMessage(extension, message) {
  const page = await extension.context.newPage();
  await page.goto(`chrome-extension://${extension.extensionId}/options.html`);
