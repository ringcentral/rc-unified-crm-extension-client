...
const handlerModules = {
  ...
  extensionAdoption: '../../src/eventHandlers/rc-post-message-request/customizedPage/inputChanged/sections/extensionAdoption.ts',
...
describe('customized page input changed router', () => {
  ...
  it('routes section changes including nested plugin cases', async () => {
    ...
    for (const [section, handlerName] of [
      ...
      ['extensionAdoption', 'extensionAdoption'],
