...
const handlerModules = {
  ...
  refreshAccountData: '../../src/eventHandlers/rc-post-message-request/custom-button-click/adminSettings/refreshAccountData.ts',
  ...
  searchContactButton: '../../src/eventHandlers/rc-post-message-request/custom-button-click/contactSearch/searchContactButton.ts',
...
describe('custom button click router', () => {
  ...
  it('routes admin setting actions', async () => {
    ...
    await expectActionRoutesTo(router, handlers, [
      ...
      ['accountDataPage', 'refreshAccountData'],
  ...
  it('routes google sheets, contact search, plugin, and user mapping actions', async () => {
    ...
    await expectActionRoutesTo(router, handlers, [
      ...
      ['contact-row-1-action', 'searchContactButton'],
