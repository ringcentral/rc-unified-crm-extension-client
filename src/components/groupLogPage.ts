...
function normalizeCorrespondentsData(correspondentsData: UnknownRecord[] | UnknownRecord): UnknownRecord[] {
...
function getGroupLogPageRender({ id, manifest, platformName, correspondentsData, useContactSearch }: UnknownRecord): UnknownRecord {
    const schemaProperties: UnknownRecord = {};
    const uiSchemaProperties: UnknownRecord = {};
    const formDataProperties: UnknownRecord = {};
...
function getUpdatedGroupLogPageRender({ manifest, platformName, updateData }: UnknownRecord): UnknownRecord {
...
function collectGroupLogFormData(formData: UnknownRecord, manifest: UnknownRecord, platformName: string): UnknownRecord[] {
    ...
    return Object.keys(formData).map(sectionKey => {
        ...
        const additionalSubmission: UnknownRecord = {};
...
export {
    getGroupLogPageRender,
    getUpdatedGroupLogPageRender,
    collectGroupLogFormData,
};
