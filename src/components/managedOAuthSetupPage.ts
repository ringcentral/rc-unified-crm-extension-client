...
function getManagedOAuthSetupPageRender({ platform, pendingValues = {} }: UnknownRecord): UnknownRecord {
...
export { getManagedOAuthSetupPageRender };
export default {
    getManagedOAuthSetupPageRender,
};
