...
function getAdvancedFeaturesSettingPageRender({ adminUserSettings }: UnknownRecord): UnknownRecord {
    const page =
    {
...
export { getAdvancedFeaturesSettingPageRender };
export default {
    getAdvancedFeaturesSettingPageRender,
};
