...
function getAutoLogPreferenceSettingPageRender({ adminUserSettings, contactTypes }: UnknownRecord): UnknownRecord {
    const newContactTypes = contactTypes.map((contactType: UnknownRecord) => ({
...
export { getAutoLogPreferenceSettingPageRender };
export default {
    getAutoLogPreferenceSettingPageRender,
};
