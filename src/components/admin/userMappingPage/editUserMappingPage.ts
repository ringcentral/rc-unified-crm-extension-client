...
function renderEditUserMappingPage({ userMapping, platformDisplayName, rcExtensions, selectedRcExtensionId }: UnknownRecord): UnknownRecord {
    return {
        ...
        uiSchema: {
            ...
            rcExtensionList: {
                ...
                "ui:options": {
                    "multiple": true,
                    "enumOptions": rcExtensions.map((rc: UnknownRecord) => {
                        return {
                            value: rc.id,
                            label: rc.name ?
        ...
        formData: {
            ...
            rcExtensionList: selectedRcExtensionId || userMapping.rcUser?.map((rc: UnknownRecord) => rc.extensionId)
        }
    }
}

export { renderEditUserMappingPage };
export default {
    renderEditUserMappingPage,
};
