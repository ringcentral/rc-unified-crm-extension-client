...
function getNotificationLevelSettingPageRender({ adminUserSettings }: UnknownRecord): UnknownRecord {
    return {
...
export { getNotificationLevelSettingPageRender };
export default {
    getNotificationLevelSettingPageRender,
};
