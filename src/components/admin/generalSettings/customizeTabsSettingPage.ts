...
function getCustomizeTabsSettingPageRender({ adminUserSettings, manifest, platformName }: UnknownRecord): UnknownRecord {
...
export { getCustomizeTabsSettingPageRender };
export default {
    getCustomizeTabsSettingPageRender,
};
