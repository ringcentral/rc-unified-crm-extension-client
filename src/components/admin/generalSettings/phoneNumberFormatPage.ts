...
function getPhoneNumberFormatPageRender({ adminUserSettings }: UnknownRecord): UnknownRecord {
    return {
...
export { getPhoneNumberFormatPageRender };
export default {
    getPhoneNumberFormatPageRender,
};
