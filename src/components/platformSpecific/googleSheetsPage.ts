...
function renderGoogleSheetsPage({ manifest, userSettings }: UnknownRecord): UnknownRecord {
...
function getUpdatedGoogleSheetsPage({ page, formData }: UnknownRecord): UnknownRecord {
...
export { getUpdatedGoogleSheetsPage, renderGoogleSheetsPage };
export default {
    getUpdatedGoogleSheetsPage,
    renderGoogleSheetsPage,
};
