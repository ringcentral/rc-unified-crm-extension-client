...
function getImplementedInterfacesPageRender({ implementedInterfaces }: UnknownRecord): UnknownRecord {
...
export { getImplementedInterfacesPageRender };
export default {
    getImplementedInterfacesPageRender,
};
