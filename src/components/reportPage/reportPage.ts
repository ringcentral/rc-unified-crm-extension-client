...
function getReportsPageRender({ selectedTab = 'userReportTab', selectedRcExtension, isAdmin = false, userStats, companyStats, selectedGroupKey, groupKeys, selectedItemKey, itemKeys, userSettings, rcExtensions = [] }: UnknownRecord): UnknownRecord {
