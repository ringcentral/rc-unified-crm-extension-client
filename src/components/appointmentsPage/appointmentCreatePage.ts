...
async function submitAppointmentCreate({ manifest, jwtToken, formData }: UnknownRecord): Promise<unknown> {
...
export { getAppointmentCreatePageRender, submitAppointmentCreate };

const appointmentCreatePage = {
  getAppointmentCreatePageRender,
  submitAppointmentCreate,
};
